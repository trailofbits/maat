...
void init_arch(PyObject* module)
{
    ...
    // TODO PyDict_SetItemString(arch_enum, "ARM32", PyLong_FromLong((int)Arch::Type::ARM32));
    // TODO PyDict_SetItemString(arch_enum, "ARM64", PyLong_FromLong((int)Arch::Type::ARM64));
