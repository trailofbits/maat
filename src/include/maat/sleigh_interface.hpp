...
namespace maat
{
    ...
    inline maat::ir::Param sleigh_reg_translate_PPC64(const std::string& reg_name);
    inline maat::ir::Param sleigh_masked_reg_translate_PPC64(const std::string& reg_name, const int size);
}
