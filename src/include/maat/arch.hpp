...
namespace ARM64
{
    ...
    static constexpr reg_t R0   = 0;    // X0
    static constexpr reg_t R1   = 1;    // X1
    static constexpr reg_t R2   = 2;    // X2
    static constexpr reg_t R3   = 3;    // X3
    static constexpr reg_t R4   = 4;    // X4
    static constexpr reg_t R5   = 5;    // X5
    static constexpr reg_t R6   = 6;    // X6
    static constexpr reg_t R7   = 7;    // X7
    static constexpr reg_t R8   = 8;    // X8
    static constexpr reg_t R9   = 9;    // X9
    static constexpr reg_t R10  = 10;   // X10
    static constexpr reg_t R11  = 11;   // X11
    static constexpr reg_t R12  = 12;   // X12
    static constexpr reg_t R13  = 13;   // X13
    static constexpr reg_t R14  = 14;   // X14
    static constexpr reg_t R15  = 15;   // X15
    static constexpr reg_t R16  = 16;   // X16
    static constexpr reg_t R17  = 17;   // X17
    static constexpr reg_t R18  = 18;   // X18
    static constexpr reg_t R19  = 19;   // X19
    static constexpr reg_t R20  = 20;   // X20
    static constexpr reg_t R21  = 21;   // X21
    static constexpr reg_t R22  = 22;   // X22
    static constexpr reg_t R23  = 23;   // X23
    static constexpr reg_t R24  = 24;   // X24
    static constexpr reg_t R25  = 25;   // X25
    static constexpr reg_t R26  = 26;   // X26
    static constexpr reg_t R27  = 27;   // X27
    static constexpr reg_t R28  = 28;   // X28
    static constexpr reg_t R29  = 29;   // X29 Frame pointer
    ...
    static constexpr reg_t V2   = 34;   // V2
    static constexpr reg_t V3   = 35;   // V3
    static constexpr reg_t V4   = 36;   // V4
    static constexpr reg_t V5   = 37;   // V5
    static constexpr reg_t V6   = 38;   // V6
    static constexpr reg_t V7   = 39;   // V7
    static constexpr reg_t V8   = 40;   // V8
    static constexpr reg_t V9   = 41;   // V9
    static constexpr reg_t V10  = 42;   // V10
    static constexpr reg_t V11  = 43;   // V11
    static constexpr reg_t V12  = 44;   // V12
    static constexpr reg_t V13  = 45;   // V13
    static constexpr reg_t V14  = 46;   // V14
    static constexpr reg_t V15  = 47;   // V15
    static constexpr reg_t V16  = 48;   // V16
    static constexpr reg_t V17  = 49;   // V17
    static constexpr reg_t V18  = 50;   // V18
    static constexpr reg_t V19  = 51;   // V19
    static constexpr reg_t V20  = 52;   // V20
    static constexpr reg_t V21  = 53;   // V21
    static constexpr reg_t V22  = 54;   // V22
    static constexpr reg_t V23  = 55;   // V23
    static constexpr reg_t V24  = 56;   // V24
    static constexpr reg_t V25  = 57;   // V25
    static constexpr reg_t V26  = 58;   // V26
    static constexpr reg_t V27  = 59;   // V27
    static constexpr reg_t V28  = 60;   // V28
